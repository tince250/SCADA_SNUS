...
{
    public class UpdateInputHandler : WebSocketHandler
    {
        public UpdateInputHandler(WebSocketConnectionManager webSocketConnectionManager) : base(webSocketConnectionManager)
        {
        }
